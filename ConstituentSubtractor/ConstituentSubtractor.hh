// $Id: ConstituentSubtractor.hh 1067 2017-09-08 14:33:51Z berta $
//
...
///
  ...
  public:
    ...
    ///
    /// set to true, if you want remove all zero pt particles - this means removing also particles with zero delta_m (massive particles with zero pt). Defaulty, the zero pt particles with non-zero delta_m are not removed. 
